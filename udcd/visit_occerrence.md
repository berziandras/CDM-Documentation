...
2. Union and Map to OMOP Concepts
...
| visit_concept_id               | patient_type, profession_code, department_code | Map: 'IP' → 9201; 'OP' → 9202; 'CURE' → 8756; 'ERIP' → 262; 'ER' → 9203; 'INT' → 32037; ELSE → 0 | |
...
| visit_source_value             | patient_type, profession_code, department_code | | |
