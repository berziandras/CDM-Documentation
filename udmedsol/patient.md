...
Combines and harmonizes medical patient records from two hospital information systems — MEDSOL and UDMED — into a single unified table. For demographic attributes where the "true" or most recent value is unknown, `MIN()` is used as a deterministic tiebreaker to consistently pick one value.
