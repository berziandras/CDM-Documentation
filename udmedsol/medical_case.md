...
Combines and harmonizes medical case records from two hospital information systems — MEDSOL and UDMED — into a single unified table, with standardized department codes, deduplicated department metadata, and parsed datetime fields:
 ...
 - A traceable link back to the originating source department
